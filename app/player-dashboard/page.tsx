          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-muted">
                Single-game player review with video and involvement playlist kept together.
              </p>
            </div>

            <AppTopNav current="player-dashboard" />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-3 xl:grid-cols-[320px_minmax(0,1fr)]">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  router.push(
                    `/player-dashboard?player=${encodeURIComponent(e.target.value)}`
                  )
                }
              ...
              <div className="rounded-2xl border border-border bg-panel p-4 shadow-[var(--shadow-soft)]">
                {videoSrc ? (
                  ...
                  <div className="rounded-xl border border-border bg-panel-2 px-4 py-4 text-sm text-muted">
                    No video is available in this session yet. Open the workspace and load a match video first.
                  </div>
                )}
              </div>

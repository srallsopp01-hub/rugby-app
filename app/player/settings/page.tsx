    ...
    <div className="p-8 max-w-2xl">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-muted leading-relaxed">
          Account and notification preferences. Manage your profile, linked
          teams, and how your data is shared with your coaching staff.
        </p>
      </div>
      <div className="rounded-xl border border-dashed border-border bg-panel p-6 text-sm text-muted">
        Planned for an upcoming release. Will include profile management and team privacy preferences.
      </div>
    </div>
  );
}

          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-2 text-sm text-muted">
                Use this screen for no-video team analysis, player output
                review, unit trends, and match-level takeaways after tagging is
                complete.
              </p>
            </div>
        ...
        <div className="rounded-2xl border border-border bg-panel p-4 shadow-[var(--shadow-soft)]">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            ...
            <div className="rounded-xl border border-border bg-panel-2 p-4">
              ...
              <div className="mt-1 text-sm text-muted">
                Download the full match report as a text file, or export the
                player stats table as a CSV for Excel or Numbers.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-panel p-5 shadow-[var(--shadow-soft)]">
          ...
          {reportRows.length === 0 && (
            <p className="mt-3 text-xs text-muted">
              Complete tagging in the Workspace and reopen Team Analytics to
              enable export.
            </p>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-12">
          <section className="space-y-5 xl:col-span-8">
            ...
            <div className="rounded-2xl border border-border bg-panel p-5 shadow-[var(--shadow-soft)]">
              ...
              <p className="mt-4 text-sm leading-6 text-muted">
                Team Analytics is the clean no-video screen for team stats,
                player output, set-piece outcomes, and KPI-style review. Use
                Team Review when you want to watch the footage and jump through
            ...
            <div className="rounded-2xl border border-border bg-panel p-5 shadow-[var(--shadow-soft)]">
              ...
              {headlineInsights.length === 0 ? (
                <div className="rounded-xl border border-border bg-panel-2 px-4 py-4 text-sm text-muted">
                  No headline insights yet. Complete tagging in the Workspace,
                  then reopen Team Analytics.
                </div>
              ) : (
            ...
            <div className="rounded-2xl border border-border bg-panel p-5 shadow-[var(--shadow-soft)]">
              ...
              {reportRows.length === 0 ? (
                <div className="rounded-xl border border-border bg-panel-2 px-4 py-4 text-sm text-muted">
                  No player report data yet. Complete tagging in the Workspace,
                  check player minutes, then reopen Team Analytics.
                </div>
              ) : (
                        ...
                        >
                          ...
                          <td className="p-2">
                            <button
                              onClick={() =>
                                router.push(
                                  `/player-dashboard?player=${encodeURIComponent(
                                    row.name
                                  )}`
                                )
                              }
          ...
          <aside className="space-y-5 xl:col-span-4 xl:sticky xl:top-5 xl:max-h-[calc(100vh-2rem)] xl:overflow-y-auto xl:pr-1">
            <div className="rounded-2xl border border-border bg-panel p-4 shadow-[var(--shadow-soft)]">
              ...
              <p className="mt-2 text-sm text-muted">
                Use this sidebar for the quickest read on team output,
                set-piece success, and unit trends from the current saved
                match.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-panel p-5 shadow-[var(--shadow-soft)]">
              ...
              <p className="mt-3 text-sm leading-6 text-muted">
                Team Analytics currently works from the saved match on this
                browser and device. It is designed for coach review right now,
                before full cloud storage and multi-user sharing are added
                later.
              </p>
            </div>
          </aside>

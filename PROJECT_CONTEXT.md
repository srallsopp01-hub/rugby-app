...
- ✅ `/coach/team` added with player/coach invite form, optional coach labels (Head / Forwards / Backs / 2nd team / custom), squad-player linking, member list, revoke action, editable team name, and Coach sidebar link
